...
fun createCard(){
        ...
        .fillMaxHeight())
    {
        Card(modifier = Modifier
            .width(200.dp)
            .height(390.dp)
            .padding(15.dp), shape = RoundedCornerShape(corner = CornerSize(15.dp)),
...
fun Content(){
        ...
        .fillMaxHeight())
    {
        ...
        border = BorderStroke(width = 2.dp, color = Color.LightGray)) {
            ...
            Portolio(data = listOf("Project 1","Project 2","Project 3"))
        }
...
private fun CreateInfo() {
    Column(modifier = Modifier.padding(5.dp)) {
        ...
        Text(
            text = "@sidd", modifier = Modifier.padding(3.dp),
            style = MaterialTheme.typography.h5
        )
    }
}
...
private fun CreateImageProfile(modifier: Modifier = Modifier) {
    ...
    {
        Image(
            painter = painterResource(id = R.drawable.sid),
            contentDescription = "profile images",
